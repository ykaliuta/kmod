...
map=(
    ...
    ["test-depmod/reject-search-order-simple/lib/modules/4.4.4/kernel/crypto/"]="mod-simple.ko"
    ["test-depmod/reject-search-order-simple/lib/modules/4.4.4/updates/"]="mod-simple.ko"
